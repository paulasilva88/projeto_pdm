...
export default function App() {
   ...
   const submeterLogin =(texto) => {
    Axios.post( "http://192.168.0.104:3006/login", {CPF, senha} )
   }
        ...
        <View style={styles.container}>
            ...
            <View style={styles.inputArea}>
                ...
                <TouchableOpacity
                    ...
                    onPress={() => submeterLogin(CPF, senha) }>
                    <Text style={styles.textButtom}>Cadastrar</Text>
                </TouchableOpacity>


                <TouchableOpacity
                    style={styles.buttomConta}
                    onPress={() => navigation.navigate('Menu')} >
                    <Text style={styles.textButtom}>Minha Conta</Text>
                </TouchableOpacity>
                </View>
